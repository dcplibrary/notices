...
<div class="px-4 sm:px-6 lg:px-8">
    <div class="max-w-3xl mx-auto">
        <!-- Header -->
        <div class="mb-6">
            <a href="{{ route('notifications.settings.index') }}" class="text-sm text-indigo-600 hover:text-indigo-900 flex items-center">
        ...
        <div class="bg-white shadow sm:rounded-lg">
            <form action="{{ route('notifications.settings.update', $setting->id) }}" method="POST">
                @csrf
                @method('PUT')
