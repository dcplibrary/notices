...
@section('content')
    <div class="px-4 sm:px-0">
        ...
        <div x-data="syncHistoryManager()" class="mb-8">
                                    ...
                                    @foreach($recentSyncs as $log)
                                        <tr>
                                            <td class="px-3 py-2 whitespace-nowrap text-sm text-gray-900">
                                                {{ $operationLabels[$log->operation_type] ?? Str::headline(str_replace('_', ' ', $log->operation_type)) }}
                                            </td>
            ...
            {{-- Log details modal --}}
            <div x-show="showLogModal" x-cloak class="fixed z-50 inset-0 overflow-y-auto" aria-labelledby="modal-title"
                                        ...
                                        <div class="space-y-3">
                                            ...
                                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-2 text-sm text-gray-700">
                                                ...
                                                <div>
                                                    ...
                                                    <span class="ml-1"
                                                          x-text="currentLog.duration_seconds ? currentLog.duration_seconds + 's' : '—'"></span>
                                                </div>
                                                <div>
                                                    <span class="font-semibold">Records processed:</span>
                                                    <span class="ml-1"
                                                          x-text="currentLog.records_processed ?? 0"></span>
                                                </div>
                                            </div>
                                            ...
                                            <template x-if="currentLog.error_message">
                                                <div class="mt-2">
                                                    ...
                                                    <p class="mt-1 text-sm text-red-600 whitespace-pre-line"
                                                       x-text="currentLog.error_message"></p>
                                                </div>
                                            </template>
                                            ...
                                            <template x-if="currentLog.results">
                                                <div class="mt-2">
                                                    ...
                                                    <pre class="mt-1 bg-gray-50 rounded-md p-3 text-xs text-gray-700 overflow-x-auto"><code
                                                                x-text="JSON.stringify(currentLog.results, null, 2)"></code></pre>
                                                </div>
                                            </template>
                                        </div>
                                    </template>
