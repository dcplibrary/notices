@php use Dcplibrary\Notices\Services\SettingsManager; @endphp
@php use Dcplibrary\Notices\Models\NotificationSetting; @endphp
                ...
                <div class="p-6">
                    ...
                    <div class="mt-4">
                        <p class="text-sm text-gray-600">
                            Use Shoutbomb failure reports to mark failed deliveries. When a notice has been submitted
...
echo e( $enabled ? 'b}}">
                            ...
                            <div class="flex flex-col sm:flex-row sm:items-center gap-1 sm:gap-3 w-full sm:w-auto">
                                ...
                                <button type="button"
                                        ...
                                        class="text-xs text-gray-700 hover:text-gray-900 underline text-left">
                                    How to install
                                </button>
                            </div>
                        </div>
            ...
            <!-- Sync & Import (Data Management) Card -->
            <div class="bg-white overflow-hidden shadow rounded-lg">
                <div class="p-6">
                    <div class="flex items-center">
                        <div class="flex-shrink-0">
                    ...
                    <div class="mt-4">
                        <p class="text-sm text-gray-600">
                            Import data from Polaris and Shoutbomb and monitor sync status.
                        </p>
                    </div>
                    <div class="mt-4 flex items-center gap-3">
                        <a href="/notices/settings/sync"
                           class="inline-flex items-center px-3 py-2 border border-transparent text-sm font-medium rounded-md shadow-sm text-white bg-indigo-600 hover:bg-indigo-700">Open
                            Sync & Import</a>
                    </div>
                </div>
            </div>
    ...
    <!-- Install Modal -->
    <div id="sb-install-modal" class="hidden fixed inset-0 z-50 overflow-y-auto" aria-labelledby="modal-title"
         role="dialog" aria-modal="true">
        <div class="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
            <div class="fixed inset-0 bg-gray-500 bg-opacity-75 transition-opacity" aria-hidden="true"
                 onclick="document.getElementById('sb-install-modal').classList.add('hidden')"></div>
            ...
            <div class="inline-block align-bottom bg-white rounded-lg px-4 pt-5 pb-4 text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full sm:p-6">
                <div>
                    ...
                    <div class="mt-3 text-center sm:mt-5">
                        <h3 class="text-lg leading-6 font-medium text-gray-900" id="modal-title">Install Shoutbomb
                            Reports</h3>
                        <div class="mt-2">
                            <p class="text-sm text-gray-500">If not already installed in your Laravel app, follow these
                                steps:</p>
                            <ol class="mt-3 text-left text-sm text-gray-700 list-decimal list-inside space-y-2">
                                <li>Ensure the dcplibrary/notices package is installed and migrated:
                                    <div class="mt-1">
                                        <code class="bg-gray-100 px-2 py-1 rounded text-xs">composer require
                                            dcplibrary/notices</code><br>
                ...
                <div class="mt-5 sm:mt-6 sm:flex sm:flex-row-reverse">
                    <button type="button"
                            ...
                            onclick="document.getElementById('sb-install-modal').classList.add('hidden')">Got it
                    </button>
                    <button type="button"
                            class="mt-3 w-full inline-flex justify-center rounded-md border border-gray-300 shadow-sm px-4 py-2 bg-white text-base font-medium text-gray-700 hover:bg-gray-50 sm:mt-0 sm:w-auto sm:text-sm"
                            onclick="document.getElementById('sb-install-modal').classList.add('hidden')">Close
                    </button>
                </div>
            </div>
        </div>
