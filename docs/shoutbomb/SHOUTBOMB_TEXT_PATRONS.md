...
# SAMPLE ROWS (Text notification patrons):
5551001002|23307000001002
5551001004|23307000001004
5551001006|23307000001006
5551001008|23307000001008
5551001010|23307000001010
```

**Sample Patron Details:**
- **5551001002** - Bob Martinez (Has 1st overdue)
- **5551001004** - David Thompson (Has hold AND overdue)
- **5551001006** - Frank Rodriguez (Has 3rd overdue)
- **5551001008** - Henry Jackson (Has renewal reminder)
- **5551001010** - James Taylor (Has overdue)

**Cross-Reference Note:** These same patron barcodes appear in holds.txt, overdue.txt, renew.txt, and PhoneNotices.csv. See ANONYMIZED_SAMPLE_DATA_REFERENCE.md for complete cross-reference mapping.

**Important:** These phone numbers do NOT appear in voice_patrons.txt (demonstrates conflict resolution).
